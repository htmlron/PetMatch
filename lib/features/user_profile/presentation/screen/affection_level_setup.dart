...
class _AffectionLevelSetupScreenState
  ...
  static const Color _accent = Color.fromARGB(255, 133, 54, 179);
  ...
  void initState() {
    super.initState();
    _selected = ref.read(userProfileProvider).lifestylePace;
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'How does your day-to-day rhythm usually feel?',
                  ...
                  onPressed: canContinue
                      ? () {
                          ...
                          if (onboardingComplete) {
                            ...
                            notifier.setLifestylePace(context, value);
                          }
                        }
                      : null,
