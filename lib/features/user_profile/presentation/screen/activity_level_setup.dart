...
class _ActivityLevelSetupScreenState
  ...
  static const Color _accent = Color.fromARGB(255, 247, 127, 211);
  ...
  void initState() {
    super.initState();
    _selected = ref.read(userProfileProvider).livingEnvironment;
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Choose what best describes your home setup.',
                  ...
                  onPressed: canContinue
                      ? () {
                          ...
                          if (onboardingComplete) {
                            ...
                            notifier.setLivingEnvironment(context, value);
                          }
                        }
                      : null,
