...
class _GroomingLevelSetupScreenState
  ...
  void initState() {
    super.initState();
    _selected = ref.read(userProfileProvider).petOwnershipExperience;
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Choose what best matches your experience with pets.',
                      ...
                      ? () {
                          ...
                          if (onboardingComplete) {
                            notifier.updateLifestylePreference(
                              key: 'pet_ownership_experience',
                              value: value,
                            );
                            Navigator.of(context).pop();
                          } else {
                            notifier.setPetOwnershipExperience(context, value);
                          }
                        }
                      : null,
